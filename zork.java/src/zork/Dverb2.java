...
public class Dverb2
{
	...
	void savegm_() throws IOException
	{
	   ...
	   try
	   {
		   ...
		   if (vars.play_1.telflg) writeInt(writer, 1); else writeInt(writer, 0);
		   if (vars.hack_1.thfflg)  writeInt(writer, 1); else writeInt(writer, 0);
		   if (vars.hack_1.thfact) writeInt(writer, 1); else writeInt(writer, 0);
		   if (vars.hack_1.swdact) writeInt(writer, 1); else writeInt(writer, 0);
		   writeInt(writer, vars.hack_1.swdsta);
		   for(int i = 0; i < 64; i++) writeInt(writer, vars.puzzle_1.cpvec[i]);
		   ...
		   for(int i = 0; i < 220; i++) writeInt(writer, vars.objcts_1.odesc1[i]);
		   for(int i = 0; i < 220; i++) writeInt(writer, vars.objcts_1.odesc2[i]);
		   for(int i = 0; i < 220; i++) writeInt(writer, vars.objcts_1.oflag1[i]);
		   for(int i = 0; i < 220; i++) writeInt(writer, vars.objcts_1.oflag2[i]);
		   for(int i = 0; i < 220; i++) writeInt(writer, vars.objcts_1.ofval[i]);
		   for(int i = 0; i < 220; i++) writeInt(writer, vars.objcts_1.otval[i]);
		   for(int i = 0; i < 220; i++) writeInt(writer, vars.objcts_1.osize[i]);
		   for(int i = 0; i < 220; i++) writeInt(writer, vars.objcts_1.ocapac[i]);
		   for(int i = 0; i < 220; i++) writeInt(writer, vars.objcts_1.oroom[i]);
		   for(int i = 0; i < 220; i++) writeInt(writer, vars.objcts_1.oadv[i]);
		   for(int i = 0; i < 220; i++) writeInt(writer, vars.objcts_1.ocan[i]);
	
		   for(int i = 0; i < 200; i++) writeInt(writer, vars.rooms_1.rval[i]);
		   for(int i = 0; i < 200; i++) writeInt(writer, vars.rooms_1.rflag[i]);
	
		   for(int i = 0; i < 4; i++) writeInt(writer, vars.advs_1.aroom[i]);
		   for(int i = 0; i < 4; i++) writeInt(writer, vars.advs_1.ascore[i]);
		   for(int i = 0; i < 4; i++) writeInt(writer, vars.advs_1.avehic[i]);
		   for(int i = 0; i < 4; i++) writeInt(writer, vars.advs_1.astren[i]);
		   for(int i = 0; i < 4; i++) writeInt(writer, vars.advs_1.aflag[i]);
	
		   for(int i = 0; i < 46; i++) { if (vars.findex_1.flags(i)) writeInt(writer, 1); else writeInt(writer, 0);}
		   for(int i = 0; i < 22; i++) writeInt(writer, vars.findex_1.switch_(i));
		   for(int i = 0; i < 4; i++) writeInt(writer, vars.vill_1.vprob[i]);
		   for(int i = 0; i < 25; i++) { if (vars.cevent_1.cflag[i]) writeInt(writer, 1); else writeInt(writer, 0);}
		   for(int i = 0; i < 25; i++) writeInt(writer, vars.cevent_1.ctick[i]);
		   writer.flush();
		   writer.close();
...
//		writer.write(bytes);
	...
	void rstrgm_() throws IOException
	{
	   ...
	   try
	   {
		   ...
		   for(int i = 0; i < 64; i++) vars.puzzle_1.cpvec[i] = reader.read();
		   ...
		   for(int i = 0; i < 220; i++) vars.objcts_1.odesc1[i] = reader.read();
		   for(int i = 0; i < 220; i++) vars.objcts_1.odesc2[i] = reader.read();
		   for(int i = 0; i < 220; i++) vars.objcts_1.oflag1[i] = reader.read();
		   for(int i = 0; i < 220; i++) vars.objcts_1.oflag2[i] = reader.read();
		   for(int i = 0; i < 220; i++) vars.objcts_1.ofval[i] = reader.read();
		   for(int i = 0; i < 220; i++) vars.objcts_1.otval[i] = reader.read();
		   for(int i = 0; i < 220; i++) vars.objcts_1.osize[i] = reader.read();
		   for(int i = 0; i < 220; i++) vars.objcts_1.ocapac[i] = reader.read();
		   for(int i = 0; i < 220; i++) vars.objcts_1.oroom[i] = reader.read();
		   for(int i = 0; i < 220; i++) vars.objcts_1.oadv[i] = reader.read();
		   for(int i = 0; i < 220; i++) vars.objcts_1.ocan[i] = reader.read();
	
		   for(int i = 0; i < 200; i++) vars.rooms_1.rval[i] = reader.read();
		   for(int i = 0; i < 200; i++) vars.rooms_1.rflag[i] = reader.read();
	
		   for(int i = 0; i < 4; i++) vars.advs_1.aroom[i] = reader.read();
		   for(int i = 0; i < 4; i++) vars.advs_1.ascore[i] = reader.read();
		   for(int i = 0; i < 4; i++) vars.advs_1.avehic[i] = reader.read();
		   for(int i = 0; i < 4; i++) vars.advs_1.astren[i] = reader.read();
		   for(int i = 0; i < 4; i++) vars.advs_1.aflag[i] = reader.read();
	
		   for(int i = 0; i < 46; i++) vars.findex_1.flags(i, reader.read() != 0);
//		   do_uio(46, &flags[0], sizeof(boolean));
		   for(int i = 0; i < 22; i++) vars.findex_1.switch_(i, reader.read());
		   for(int i = 0; i < 4; i++) vars.vill_1.vprob[i] = reader.read();
//		   do_uio(25, &cevent_1.cflag[0], sizeof(boolean));
		   for(int i = 0; i < 25; i++) vars.cevent_1.cflag[i] = reader.read() != 0;
		   for(int i = 0; i < 25; i++) vars.cevent_1.ctick[i] = reader.read();
